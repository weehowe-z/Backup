...
class BPNeuronNetwork(object):
    ...
    def cal(self, input):
        ...
        for i in xrange(0, self.hiddenNum):
            ...
            inputSum += self.hiddenLayer.neurons[
                i].weights[hiddenLayerInputNum] * self.bias
        ...
        for i in xrange(0, self.outputNum):
            ...
            for j in xrange(0, outputLayerInputNum):
                inputSum += self.outputLayer.neurons[i].weights[
                    j] * self.hiddenLayer.neurons[j].activation
            inputSum += self.outputLayer.neurons[
                i].weights[outputLayerInputNum] * self.bias
